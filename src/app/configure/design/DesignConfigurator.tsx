...
const DesignConfigurator = ({configId, imageUrl, imageDimensions}:DesignConfiguratorProps) => {
    ...
    return <div className="relative mt-20 grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
                        ...
                        >
                          <span className="flex items-center">
                            <span className="flex flex-col text-sm">
                              <RadioGroup.Label className='font-edium text-gray-900' as="span">
                                {option.label}
                              </RadioGroup.Label>
                          ...
                          <RadioGroup.Description as="span" className="mt-2 text-sm sm:ml-4 sm:mt-0 sm:flex-col sm:text-right">
          ...
          <div className="w-full h-full flex justify-end items-center">
            <div className="w-full flex gap-6 items-center">
                <p className="font-medium whitespace-nowrap">
                  {formatPrice((BASE_PRICE)/100 + (options.finish.price)/100 + (options.material.price)/100)}
                </p>
